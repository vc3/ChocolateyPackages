...
$packageName= 'diskexplorer' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://hp.vector.co.jp/authors/VA013937/editdisk/editd169e.rar' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'diskexplorer*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
