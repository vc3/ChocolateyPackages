...
$packageName= 'fatimgen' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://sourceforge.net/projects/fatimgen/files/fat_imgen%202.2.4/fat_imgen-2.2.4-Windows-i386.zip/download' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'fatimgen*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
