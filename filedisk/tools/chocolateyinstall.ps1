...
$packageName= 'filedisk' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://www.acc.umu.se/~bosse/filedisk/filedisk-15-signed.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'filedisk*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
