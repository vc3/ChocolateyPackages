...
$packageName= 'bfi' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://www.nu2.mostlycreativeworkshop.com/files/bfi10.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'bfi*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
